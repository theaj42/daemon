...
export const publicData = {
  ...
  "projects": [
    {
      ...
      "status": "active",
      "description": "Privacy-first AI context system with self-contained agents and local memory",
      "tags": [
        "ai",
        "claude-code",
        "privacy",
    ...
    },
    {
      ...
      "status": "active",
      "description": "Handwritten journal to digital text pipeline using AI transcription",
      "tags": [
        "automation",
        "journaling",
        "ocr"
  ...
  "interests": [
    ...
    {
      "topic": "Privacy-First Computing",
      "why": "Believe in local-first, user-controlled AI infrastructure",
      "tags": [
        "privacy",
        "local-first",
        "self-hosted"
